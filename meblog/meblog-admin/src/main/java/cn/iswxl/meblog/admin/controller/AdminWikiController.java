...
public class AdminWikiController {
    ...
    @RequiresPermission(value = {"admin:wiki:add"})
    ...
    @RequiresPermission(value = {"admin:wiki:delete"})
    ...
    @RequiresPermission(value = {"admin:wiki:list"})
    ...
    @RequiresPermission(value = {"admin:wiki:isTop:update"})
    ...
    @RequiresPermission(value = {"admin:wiki:isPublish:update"})
    ...
    @RequiresPermission(value = {"admin:wiki:update"})
    ...
    @RequiresPermission(value = {"admin:wiki:catalog:list"})
    ...
    @RequiresPermission(value = {"admin:wiki:catalog:update"})
