...
import cn.iswxl.meblog.admin.convert.WikiConvert;
...
import cn.iswxl.meblog.common.domain.dos.WikiCatalogDO;
import cn.iswxl.meblog.common.domain.dos.WikiDO;
import cn.iswxl.meblog.common.domain.mapper.ArticleMapper;
import cn.iswxl.meblog.common.domain.mapper.WikiCatalogMapper;
import cn.iswxl.meblog.common.domain.mapper.WikiMapper;
import cn.iswxl.meblog.common.enums.ArticleTypeEnum;
import cn.iswxl.meblog.common.enums.ResponseCodeEnum;
import cn.iswxl.meblog.common.enums.WikiCatalogLevelEnum;
...
public class AdminWikiServiceImpl implements AdminWikiService {
    ...
    public Response deleteWiKi(DeleteWikiReqVO deleteWiKiReqVO) {
        ...
        // 若知识库不存在
        if (count == 0) {
            log.warn("此知识库不存在，wikiId: {}", wikiId);
