package cn.iswxl.meblog.common.aspect;
...
public class ApiOperationLogAspect {
    /** 以自定义 @ApiOperationLog 注解为切入点，凡是添加 @ApiOperationLog 的方法，都会执行环绕中的代码 **/
    @Pointcut("@annotation(cn.iswxl.meblog.common.annotation.ApiOperationLog)")
